*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVOPS_TCKM2
*   generation date: 13.03.2019 at 17:16:50
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVOPS_TCKM2         .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVOPS_TCKM2'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVOPS_TCKM2_EXTRACT
TOTAL = ZVOPS_TCKM2_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVOPS_TCKM2'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVOPS_TCKM2-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVOPS_TCKM2_EXTRACT
TOTAL = ZVOPS_TCKM2_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVOPS_TCKM2-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVOPS_TCKM2'
...
TOTAL = ZVOPS_TCKM2_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVOPS_TCKM2-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVOPS_TCKM2-UPD_FLAG NE SPACE.
