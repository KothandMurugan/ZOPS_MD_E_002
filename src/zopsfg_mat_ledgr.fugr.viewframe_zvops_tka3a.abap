*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVOPS_TKA3A
*   generation date: 14.03.2019 at 07:08:20
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVOPS_TKA3A         .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVOPS_TKA3A'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVOPS_TKA3A_EXTRACT
TOTAL = ZVOPS_TKA3A_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVOPS_TKA3A'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVOPS_TKA3A-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVOPS_TKA3A_EXTRACT
TOTAL = ZVOPS_TKA3A_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVOPS_TKA3A-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVOPS_TKA3A'
...
TOTAL = ZVOPS_TKA3A_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVOPS_TKA3A-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVOPS_TKA3A-UPD_FLAG NE SPACE.
