*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVOPS_TVSTZ_STOR
*   generation date: 13.03.2019 at 17:30:28
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVOPS_TVSTZ_STOR    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVOPS_TVSTZ_STOR'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVOPS_TVSTZ_STOR_EXTRACT
TOTAL = ZVOPS_TVSTZ_STOR_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVOPS_TVSTZ_STOR'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVOPS_TVSTZ_STOR-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVOPS_TVSTZ_STOR_EXTRACT
TOTAL = ZVOPS_TVSTZ_STOR_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVOPS_TVSTZ_STOR-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVOPS_TVSTZ_STOR'
...
TOTAL = ZVOPS_TVSTZ_STOR_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVOPS_TVSTZ_STOR-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVOPS_TVSTZ_STOR-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVOPS_TVSTZ_STOR'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVOPS_TVSTZ_STOR-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVOPS_TVSTZ_STOR_EXTRACT
TOTAL = ZVOPS_TVSTZ_STOR_TOTAL
