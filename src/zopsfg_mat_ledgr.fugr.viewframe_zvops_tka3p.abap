*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVOPS_TKA3P
*   generation date: 14.03.2019 at 07:16:13
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVOPS_TKA3P         .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVOPS_TKA3P'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVOPS_TKA3P_EXTRACT
TOTAL = ZVOPS_TKA3P_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVOPS_TKA3P'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVOPS_TKA3P-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVOPS_TKA3P_EXTRACT
TOTAL = ZVOPS_TKA3P_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVOPS_TKA3P-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVOPS_TKA3P'
...
TOTAL = ZVOPS_TKA3P_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVOPS_TKA3P-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVOPS_TKA3P-UPD_FLAG NE SPACE.
