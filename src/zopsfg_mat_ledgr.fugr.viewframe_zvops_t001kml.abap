*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVOPS_T001KML
*   generation date: 13.03.2019 at 17:12:00
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVOPS_T001KML       .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVOPS_T001KML'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVOPS_T001KML_EXTRACT
TOTAL = ZVOPS_T001KML_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVOPS_T001KML'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVOPS_T001KML-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVOPS_T001KML_EXTRACT
TOTAL = ZVOPS_T001KML_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVOPS_T001KML-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVOPS_T001KML'
...
TOTAL = ZVOPS_T001KML_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVOPS_T001KML-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVOPS_T001KML-UPD_FLAG NE SPACE.
