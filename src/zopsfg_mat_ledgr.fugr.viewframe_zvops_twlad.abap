*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVOPS_TWLAD
*   generation date: 13.03.2019 at 17:34:32
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVOPS_TWLAD         .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVOPS_TWLAD'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVOPS_TWLAD_EXTRACT
TOTAL = ZVOPS_TWLAD_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVOPS_TWLAD'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVOPS_TWLAD-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVOPS_TWLAD_EXTRACT
TOTAL = ZVOPS_TWLAD_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVOPS_TWLAD-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVOPS_TWLAD'
...
TOTAL = ZVOPS_TWLAD_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVOPS_TWLAD-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVOPS_TWLAD-UPD_FLAG NE SPACE.
